...
public class UIScript extends Script {
	...
	public void Tick() {
		String position = "Position: "+(int)(Scene.currentScene.player.getGlobalPosition().getX()+Scene.currentScene.world_origin.x)+","+(int)Scene.currentScene.player.getGlobalPosition().getY()+","+(int)(Scene.currentScene.player.getGlobalPosition().getZ()+Scene.currentScene.world_origin.y); 
